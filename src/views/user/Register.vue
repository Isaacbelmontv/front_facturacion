      ...
      <b-card class="auth-card" no-body>
          <div class="position-relative image-side ">
            <p class=" text-white h2">{{ $t('dashboards.txt-login') }}</p>
              <p class="white mb-0">  Utilice este formulario para registrarse. <br />Si eres miembro, por favor
                <router-link tag="a" to="/user/login" class="white">Inicia sesión</router-link>.
              </p>
          </div>
          <div class="form-side">
            <!-- logo comentado -->
